...
class ConversationsAdapter(private val context: Context, private var conversations : List<Conversation>)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.handleTextView.text = "@${conversation.users.username}"
        holder.lastMessageTextView.text = conversation.messages.content
        holder.timeStampTextView.text = conversation.createdAt.toString()
    }
